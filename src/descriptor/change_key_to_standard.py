...
def change_key_to_standard(dic1,dic2):
    ...
    for key in dic2:
        if key in dic1.keys():
#        if dic1.has_key(key):
            if not key in dic3.keys():
#            if not dic3.has_key(key):    
                dic3[key] = dic2[key]
            elif key in dic3.keys():
#            elif dic3.has_key(key): 
                dic3[key] += dic2[key]
        elif not key in dic1.keys():
#        elif not dic1.has_key(key):
            ...
            if key_old in dic1.keys():
#            if dic1.has_key(key_old):
                if not key_old in dic3.keys():
#                if not dic3.has_key(key_old):    
                    dic3[key_old] = dic2[key]
                elif key_old in dic3.keys():
#                elif dic3.has_key(key_old): 
                    dic3[key_old] += dic2[key]
            elif key_new in dic1.keys():
#            elif dic1.has_key(key_new):
                if not key_new in dic3.keys():
#                if not dic3.has_key(key_new):    
                    dic3[key_new] = dic2[key]
                elif key_new in dic3.keys():
#                elif dic3.has_key(key_new): 
                    dic3[key_new] += dic2[key]
            elif not key_new in dic1.keys() and not key_old in dic1.keys():
